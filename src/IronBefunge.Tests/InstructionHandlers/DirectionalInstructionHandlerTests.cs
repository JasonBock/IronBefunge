	...
	: InstructionHandlerTests
{
   ...
   [Test]
   public static void HandleLeft() => DirectionalInstructionHandlerTests.Handle(
		   DirectionalInstructionHandler.LeftInstruction, Direction.Left);

   [Test]
   public static void HandleRandomDown() => DirectionalInstructionHandlerTests.Randomizer(Direction.Down);

   [Test]
   public static void HandleRandomLeft() => DirectionalInstructionHandlerTests.Randomizer(Direction.Left);

   [Test]
   public static void HandleRandomRight() => DirectionalInstructionHandlerTests.Randomizer(Direction.Right);

   [Test]
   public static void HandleRandomUp() => DirectionalInstructionHandlerTests.Randomizer(Direction.Up);

   [Test]
   public static void HandleRight() => DirectionalInstructionHandlerTests.Handle(
   ...
   [Test]
   public static void HandleUp() => DirectionalInstructionHandlerTests.Handle(
