...
#nullable disable
	internal ExecutionContext(List<Cell> cells, TextReader reader, TextWriter writer, TextWriter trace, RandomNumberGenerator randomizer)
		: base()
	{
		this.Cells = cells;
...
#nullable enable
	...
	internal RandomNumberGenerator Randomizer { get; }
