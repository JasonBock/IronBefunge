...
public sealed class Executor
{
	...
	public Executor(ImmutableArray<Cell> cells, TextReader reader, TextWriter writer)
		: this(cells, reader, writer, RandomNumberGenerator.Create()) { }

	public Executor(ImmutableArray<Cell> cells, TextReader reader, TextWriter writer, TextWriter trace)
		: this(cells, reader, writer, RandomNumberGenerator.Create()) =>
			this.trace = trace ?? throw new ArgumentNullException(nameof(trace));

	public Executor(ImmutableArray<Cell> cells, TextReader reader, TextWriter writer, RandomNumberGenerator randomizer)
	{
	...
	public Executor(ImmutableArray<Cell> cells, TextReader reader, TextWriter writer, TextWriter trace, RandomNumberGenerator randomizer)
