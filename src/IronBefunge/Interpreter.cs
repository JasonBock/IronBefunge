...
public sealed class Interpreter
{
	...
	public Interpreter(string[] lines, TextReader reader, TextWriter writer, RandomNumberGenerator randomizer)
		: base() =>
		this.executor = new Executor(new Parser(lines).Parse(), reader, writer, randomizer);

	public Interpreter(string[] lines, TextReader reader, TextWriter writer, TextWriter trace, RandomNumberGenerator randomizer)
		: base() =>
	...
	public Interpreter(FileInfo file, TextReader reader, TextWriter writer, RandomNumberGenerator randomizer)
		: base()
	{
		Interpreter.VerifyFile(file);
		this.executor = new Executor(
	...
	public Interpreter(FileInfo file, TextReader reader, TextWriter writer, TextWriter trace, RandomNumberGenerator randomizer)
		: base()
	{
		Interpreter.VerifyFile(file);
		this.executor = new Executor(
